...
void InstancingApp::createUniformBuffer()
{
    ...
    gx::BlendStateDesc desc;
}

void InstancingApp::createPipelineState()
{
...
void InstancingApp::createInstanceBuffer()
{
...
void InstancingApp::populateInstanceBuffer()
{
    // Populate instance data buffer
    std::vector<mat4> InstanceData( mGridSize * mGridSize * mGridSize );
...
CINDER_APP( InstancingApp, RendererGx )
